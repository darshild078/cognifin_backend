"""
CogniFin AI - Prompt Builder
=============================
Builds the prompt for the LLM from retrieved evidence.
...
def build_prompt(context: str, question: str) -> Tuple[str, str]:
    ...
    - Modern LLMs treat system instructions and user inputs separately
    - System messages set the "persona" and grounding rules
    - User messages provide the actual question
    - This separation enforces grounded citations and eliminates hallucination
